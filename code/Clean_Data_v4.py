...
if __name__ == '__main__':
    ...
    combined_stints = combine_stints(elig_hitters)
    ...
    cols_to_add = list(set(filled_na.columns) - set(cumulative_stats.columns))
    elig_hitters_cumstats = cumulative_stats.join(filled_na[cols_to_add])[filled_na.columns]
    ...
    #features = ['R_ratio', 'H_ratio', 'HR_ratio', 'RBI_ratio', 'SB_ratio', 'BB_ratio']
